<template>
  <section>
    <div class="container px-4 relative mx-auto">
      <NuxtImg
        width="1400"
        height="800"
        class="object-cover w-full h-[420px] lg:h-[560px] xl:h-[640px]"
        src="/images/homepage-hero-temp.webp"
        alt="Hero image"
        loading="eager"
      ...
      <div class="container p-32 absolute inset-0 flex flex-col items-start justify-center bg-gradient-to-l from-gray-200 md:bg-none">
        <h1 class="text-3xl md:mb-4 md:text-4xl lg:text-6xl">Just landed.</h1>
