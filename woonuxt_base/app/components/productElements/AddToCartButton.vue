...
<template>
  <button
    type="submit"
    class="flex font-bold bg-gray-800 hover:bg-primary-lumebrown text-white text-center min-w-[150px] p-2.5 gap-4 items-center justify-center focus:outline-none"
